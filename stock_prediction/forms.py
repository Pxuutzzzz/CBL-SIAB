...
class PredictionForm(forms.Form):
    ...
    open_price = forms.FloatField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "input-pro", "placeholder": "e.g., 10000", "step": "0.01"}
        ),
    )
    high_price = forms.FloatField(
        label="High Price",
        widget=forms.NumberInput(
            attrs={"class": "input-pro", "placeholder": "e.g., 10500", "step": "0.01"}
        ),
    )
    low_price = forms.FloatField(
        label="Low Price",
        widget=forms.NumberInput(
            attrs={"class": "input-pro", "placeholder": "e.g., 9800", "step": "0.01"}
        ),
    )
    close_price = forms.FloatField(
        label="Close Price",
        widget=forms.NumberInput(
            attrs={"class": "input-pro", "placeholder": "e.g., 10200", "step": "0.01"}
        ),
    )
    volume = forms.IntegerField(
        label="Volume",
        widget=forms.NumberInput(
            attrs={"class": "input-pro", "placeholder": "e.g., 50000000"}
        ),
    )
    ma5 = forms.FloatField(
        label="MA5 (Moving Average 5 days)",
        widget=forms.NumberInput(
            attrs={"class": "input-pro", "placeholder": "e.g., 10100", "step": "0.01"}
        ),
    )
    ma10 = forms.FloatField(
        label="MA10 (Moving Average 10 days)",
        widget=forms.NumberInput(
            attrs={"class": "input-pro", "placeholder": "e.g., 10050", "step": "0.01"}
        ),
    )
